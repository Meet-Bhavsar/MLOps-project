...
from networksecurity.constant.training_pipeline import TARGET_COLUMN, DATA_TRAMSFORMATION_IMPUTER_PARAMS
...
class DataTransformation:
    ...
    def get_data_transformer_object()->Pipeline:
        try:
            imputer:KNNImputer = KNNImputer(**DATA_TRAMSFORMATION_IMPUTER_PARAMS)
